(ns sb.surprisebuild-test
  (:use [com.rpl rama]
        [com.rpl.rama path])
  (:require
   [clojure.test :refer [deftest is testing]]
   [com.rpl.rama.test :as rtest]
   [sb.surprisebuild :as sb])
  (:import [java.util UUID]))

(deftest family-tree-module-test
  (with-open [ipc (rtest/create-ipc)]
    (rtest/launch-module! ipc sb/SurprisebuildModule {:tasks 4 :threads 2})
    (let [module-name (get-module-name sb/SurprisebuildModule)
          ...
          p13 (UUID/randomUUID)
          p14 (UUID/randomUUID)]
      (foreign-append! people-depot (sb/->Person p1 nil nil "Person 1"))
      (foreign-append! people-depot (sb/->Person p2 nil nil "Person 2"))
      (foreign-append! people-depot (sb/->Person p3 nil nil "Person 3"))
      (foreign-append! people-depot (sb/->Person p4 nil nil "Person 4"))
      (foreign-append! people-depot (sb/->Person p5 nil nil "Person 5"))
      (foreign-append! people-depot (sb/->Person p6 nil nil "Person 6"))
      (foreign-append! people-depot (sb/->Person p7 p1 p2 "Person 7"))
      (foreign-append! people-depot (sb/->Person p8 p3 p4 "Person 8"))
      (foreign-append! people-depot (sb/->Person p9 p1 p5 "Person 9"))
      (foreign-append! people-depot (sb/->Person p10 p7 p8 "Person 10"))
      (foreign-append! people-depot (sb/->Person p11 p9 p10 "Person 11"))
      (foreign-append! people-depot (sb/->Person p12 p10 p11 "Person 12"))
      (foreign-append! people-depot (sb/->Person p13 p10 p11 "Person 13"))
      (foreign-append! people-depot (sb/->Person p14 p10 p11 "Person 14"))
